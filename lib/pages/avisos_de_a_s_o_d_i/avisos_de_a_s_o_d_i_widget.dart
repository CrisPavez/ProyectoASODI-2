...
class AvisosDeASODIWidget extends StatefulWidget {
  const AvisosDeASODIWidget({Key? key}) : super(key: key);
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              FutureBuilder<List<AnunciosRow>>(
                                future: AnunciosTable().queryRows(
                                  queryFn: (q) => q.order('fecha_creación'),
                                ),
                                builder: (context, snapshot) {
                                  ...
                                  List<AnunciosRow> listViewAnunciosRowList =
                                      snapshot.data!;
                                  return ListView.builder(
                                    padding: EdgeInsets.zero,
                                    shrinkWrap: true,
                                    scrollDirection: Axis.vertical,
                                    itemCount: listViewAnunciosRowList.length,
                                    itemBuilder: (context, listViewIndex) {
                                      final listViewAnunciosRow =
                                          listViewAnunciosRowList[
                                              listViewIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            10.0, 10.0, 10.0, 10.0),
