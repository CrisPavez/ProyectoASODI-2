...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF67FF9F);
  late Color secondary = const Color(0xFFFFA949);
  late Color tertiary = const Color(0xFFFF603D);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFFDEFFF7);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xFF002C2C);
