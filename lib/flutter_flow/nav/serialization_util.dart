  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case FichaPersonalRow:
            return FichaPersonalRow(data);
          case AnunciosRow:
            return AnunciosRow(data);
          case GlucemiaRow:
            return GlucemiaRow(data);
          case SintomasRow:
            return SintomasRow(data);
          case MedicacionRow:
            return MedicacionRow(data);
          case PresionRow:
            return PresionRow(data);
          case UsuariosRow:
            return UsuariosRow(data);
          case CitasMedicasRow:
            return CitasMedicasRow(data);
          case PesoRow:
            return PesoRow(data);
          default:
            return null;
